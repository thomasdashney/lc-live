...
describe('loadScene', () => {
  ...
  it('sends program changes', () => {
    ...
    expect(outputs.prophet.changeProgram).toBeCalledWith(20)
    expect(outputs.juno.changeProgram).toBeCalledWith(50)
    ...
    expect(outputs.prophet.changeProgram).toBeCalledWith(70)
